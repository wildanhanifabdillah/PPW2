...
<body>
    <div class="container d-flex justify-content-center align-items-center"  style="min-height: 100vh;">
        <form action="{{ route('buku.update', $edit->id) }}" method="POST" style="width: 400px;">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="penulis" name="penulis" value="{{ $edit->penulis }}" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="tgl_terbit" name="tgl_terbit" value="{{ $edit->tgl_terbit }}" required>
            </div>
